<?php  
    ...
    if (isset($sanitasi_post['id'])) {
        $id_jenis_perbaikan = decryptId($sanitasi_post['id'], $key_akses);
        $jenis_perbaikan  = DB::connection('safaco')->table('jenis_perbaikan')
                    ->select(
                        'id_jenis_perbaikan',
                ...
                <div class="text-center p-4">
                        ...
                        <div class="card-body text-start">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <strong>Nama jenis Perbaikan:</strong> <?= htmlspecialchars($jenis_perbaikan->nama_jenis_perbaikan) ?>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <form method="POST" id="saveForm">
                        <div class="modal-body">
                            <input type="hidden" class="form-control" name="id_jenis_perbaikan" value="<?= $sanitasi_post['id']; ?>">
