<?php  
    ...
    if (isset($sanitasi_post['id'])) {
        ...
        $jadwal_kerja  = DB::connection('safaco')->table('jadwal_kerja')
                    ->select(
                        'id_jadwal_kerja',
                        'nama_jam_kerja',
                    )
           ...
           ?>
                <div class="text-center p-4">
                    <h5 class="mb-4 text-danger">
                        ...
                        Apakah Anda yakin ingin menghapus data jam kerja berikut?
                    </h5>
                    <div class="card border-0 shadow-lg mx-auto" style="max-width: 400px;">
                        <div class="card-body text-start">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <strong>Nama Jam Kerja:</strong> <?= htmlspecialchars($jadwal_kerja->nama_jam_kerja) ?>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <form method="POST" id="saveForm">
                        <div class="modal-body">
                            <input type="hidden" class="form-control" name="id_jadwal_kerja" value="<?= $sanitasi_post['id']; ?>">
