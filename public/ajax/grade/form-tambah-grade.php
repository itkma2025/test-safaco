...
<div class="modal-header">
    <h5 class="modal-title w-100 text-center" id="staticBackdropLabel">Tambah Data Grade</h5>
</div>
<form method="POST" id="saveForm">
    <div class="modal-body">
        <input type="hidden" class="form-control" name="id_grade" value="<?= $id_grade ?>">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-md-9">
                <input type="text" name="grade" class="form-control" maxlength="30" oninput="filterTextOnly(this)" required>
            </div>
        </div>
    </div>
