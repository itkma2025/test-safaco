<?php  
    ...
    if (isset($sanitasi_post['id'])) {
        ...
        $grade  = DB::connection('safaco')->table('produk_grade')
                    ->select(
                        'id_grade_produk',
                        'grade',
                    )
           ...
           ?>
                <div class="text-center p-4">
                    <h5 class="mb-4 text-danger">
                        ...
                        Apakah Anda yakin ingin menghapus data grade berikut?
                    </h5>
                    <div class="card border-0 shadow-lg mx-auto" style="max-width: 400px;">
                        <div class="card-body text-start">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <strong>Nama grade:</strong> <?= htmlspecialchars($grade->grade) ?>
                                </li>
                            </ul>
                        </div>
                    </div>
