...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($validator->fails()) {
        ...
        $logDir = __DIR__ . '/logs'; 
        $logFile = $logDir . '/edit_jenis_pengerjaan_form_' . date('Y-m-d') . '.log';
    ...
    try {
        ...
        $id_jenis_pengerjaan = decryptId($sanitasi_post['id_jenis_pengerjaan'],  $key_akses);
        ...
        $exists = $conn->table('jenis_pengerjaan')
            ->where('id_jenis_pengerjaan', '!=',  $id_jenis_pengerjaan) // langsung pakai array semua kondisi
