...
$queryTotal = DB::connection('safaco')->table('jenis_produksi');
if ($search !== '') {
    $queryTotal->where('nama_jenis_produksi', 'like', "%{$search}%");
}
$total   = $queryTotal->count();
$pages   = ceil($total / $limit);

// --- Query data sesuai halaman ---
$queryData = DB::connection('safaco')->table('jenis_produksi')->orderBy('nama_jenis_produksi', 'asc');
if ($search !== '') {
