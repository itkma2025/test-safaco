...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3 mt-2">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Data Provinsi</h2>
            <nav>
            ...
            <div class="me-2 mb-2 w-custom w-md-auto">
                <div class="dropdown w-custom">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                        <li>
                            <a href="data-wilayah.php?action=export-pdf-provinsi" target='blank' class="dropdown-item rounded-1">
                                <i class="ti ti-file-type-pdf me-1"></i>Export as PDF
                            </a>
                        </li>
                        <li>
                            <a href="data-wilayah.php?action=export-excel-provinsi" class="dropdown-item rounded-1">
    ...
    <div class="card border-0">
        <div class="card-body" style="min-height:70vh">
            <?php
                ...
                try {
                    if ($tokenJwt) {
                        $response = $client->get($domain_wilayah . 'api/data-provinsi.php', [
                            'headers' => [
                        ...
                        if ($statusCode === 200 && isset($result['data']) && is_array($result['data'])) {
                            ...
                            echo "<div class='alert alert-danger'>Gagal mengambil data provinsi. Status: $statusCode</div>";
                        }
                    } else {
                ...
                <table class="table table-striped table-bordered" id="tableNoExportNew">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="min-width: 200px;">Kode Provinsi</th>
                            <th class="text-center" style="min-width: 350px;">Nama Provinsi</th>
                            <th class="text-center" style="min-width: 120px;">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (!empty($data_provinsi)) : ?>
                            <?php $no = 1; foreach ($data_provinsi as $row) : ?>
                                <tr>
                                    <td class="align-middle text-center text-nowrap"><?= $no++ ?></td>
                                    <td class="align-middle text-center text-wrap"><?= htmlspecialchars($row['kode_provinsi']) ?></td>
