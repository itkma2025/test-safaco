...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3 mt-2">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Data Kelurahan</h2>
            <nav>
            ...
            <div class="me-2 mb-2 w-custom w-md-auto">
                <div class="dropdown w-custom">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                        <!-- <li>
                            <a href="data-wilayah.php?action=export-pdf-kelurahan" target='blank' class="dropdown-item rounded-1">
                                <i class="ti ti-file-type-pdf me-1"></i>Export as PDF
                            </a>
                        </li> -->
                        <li>
                            <a href="data-wilayah.php?action=export-excel-kelurahan" class="dropdown-item rounded-1">
                ...
                try {
                    if ($tokenJwt) {
                        ...
                        if ($statusCode === 200 && isset($result['data'])) {
                            ...
                            echo "<div class='alert alert-danger'>Gagal mengambil data kelurahan. Status: $statusCode</div>";
                        }
                    } else {
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="min-width: 200px;">Kode Kelurahan</th>
                            <th class="text-center" style="min-width: 300px;">Nama Kelurahan</th>
                            <th class="text-center" style="min-width: 300px;">Nama Kecamatan</th>
                            <th class="text-center" style="min-width: 200px;">Nama Kota / Kabupaten</th>
                            <th class="text-center" style="min-width: 200px;">Nama Provinsi</th>
                        ...
                        <?php if (!empty($data_kelurahan)) : ?>
                            ...
                            <?php foreach ($data_kelurahan as $row) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center"><?= htmlspecialchars($row['kode_kelurahan']) ?></td>
                                    <td class="align-middle"><?= htmlspecialchars($row['nama_kelurahan']) ?></td>
                                    <td class="align-middle"><?= htmlspecialchars($row['nama_kecamatan']) ?></td>
                                    <td class="align-middle"><?= htmlspecialchars($row['nama_kota_kab']) ?></td>
                                    <td class="align-middle text-center"><?= htmlspecialchars($row['nama_provinsi']) ?></td>
                                    <td class="align-middle text-center"><?= htmlspecialchars($row['status']) ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
