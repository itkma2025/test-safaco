...
// --- Ambil produk utama ---
$produk = $db_safaco->table('produk_satuan')
    ->where('id_produk', $id_produk_decrypt)
    ->first();
...
// --- Ambil produk master ---
$produkMaster = $db_prd_m->table('tb_produk_satuan')
...
$gambar = $db_safaco->table('produk_gambar_satuan')
