...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3 mt-2">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Data Produk Satuan</h2>
            <nav>
        ...
        <div class="card-body" style="min-height:70vh">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="text-muted medium">
                    <a href="data-produk.php?action=add-produk-satuan" class="btn btn-primary btn-mobile">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="form-switch">
                                            <input class="form-check-input updateStatus" type="checkbox" value="" id="checkNativeSwitch" <?= $checked_active ?> data-id="<?= encryptId($id_produk, $key_akses) ?>" data-status="<?= $status_active ?>" data-action="<?= encryptId('update_status_produk', $key_akses) ?>" data-routename="produk-satuan" switch>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
                                        <!-- Button detail -->
                                        <a href="data-produk.php?action=detail-produk-satuan&&id=<?= encryptId($id_produk, $key_akses) ?>" class="btn btn-sm btn-secondary" title="Detail Produk">
                                            <i class="fe fe-eye"></i>
                                        </a>
                                        <!-- Button edit -->
                                        <a href="data-produk.php?action=edit-produk-satuan&&id=<?= encryptId($id_produk, $key_akses) ?>" class="btn btn-sm btn-warning" title="Edit Produk">
