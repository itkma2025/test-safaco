            ...
            <div class="row">
                    ...
                    <div class="col-md-12 mt-3">
                        <dl class="row mb-0 detail-produk">
                            ...
                            <div class="row mb-1">
                                ...
                                <dd class="col-sm-8">
                                    <?= ($userMap[$data_produk->updated_by] ?? '-') . ' (' . date('d/m/Y H:i:s', strtotime($data_produk->updated_date)) . ')' ?>
                ...
                <div class="col-md-7">
                    <div class="d-flex justify-content-start flex-wrap gap-2">
                        ...
                        <a href="data-produk.php?action=edit-produk-satuan&&id=<?= encryptId($id_produk_decrypt, $key_akses) ?>" class="btn btn-secondary btn-mobile">
