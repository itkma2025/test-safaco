<?php require_once __DIR__ . '/query/data-kategori-penjualan.php' ?>
<!-- Sweet Alert -->
...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3 mt-2">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Data Kategori Penjualan</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Data Kategori Penjualan</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card-body" style="min-height:70vh">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="text-muted medium">
                    <button class="btn btn-primary btn-mobile btnAddKategori" data-bs-toggle="modal" data-bs-target="#addData" data-id="add">
                        <i class="fe fe-plus-circle me-1"></i>Tambah kategrori penjualan
                    </button>
                </div>
                        ...
                        <?php if (!$data_kategori->isEmpty()) : ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <button class="btn btn-sm btn-warning btnEditKategori" data-bs-toggle="modal" data-bs-target="#editData" data-id="<?= encryptId($id_kategori, $key_akses) ?>">
                                            <i class="fe fe-edit"></i>
                                        </button>
                                        <?php  
                                            if($_SESSION['role'] == "Super Admin"){
                                                ?>
                                                    <button class="btn btn-sm btn-danger btnHapusKategori" data-bs-toggle="modal" data-bs-target="#hapusData" data-id="<?= encryptId($id_kategori, $key_akses) ?>">
...
<?php 
    require_once __DIR__ . '/modal-dialog/tambah-kategori.php'; 
    require_once __DIR__ . '/modal-dialog/edit-kategori.php';
    require_once __DIR__ . '/modal-dialog/hapus-kategori.php';
?>
