...
<h2 style="text-align:center;">Data Produk Set</h2>
<table>
    <thead>
        <tr>
            <th style="width:5%;">No</th>
            <th style="width:15%;">Kode Produk Set</th>
            <th style="width:30%;">Nama Produk Set</th>
...
if (!empty($data_produk)) {
    ...
    foreach ($data_produk as $row) {
        $html .= '  <tr>
                        ...
                        <td>' . htmlspecialchars($row->kode_produk_set) . '</td>
                        <td>' . htmlspecialchars($row->nama_produk_set) . '</td>
