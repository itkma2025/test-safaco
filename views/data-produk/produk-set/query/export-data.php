...
// --- Ambil produk ---
$produkList = $db_safaco->table('produk_set')
    ->select('id_produk_set', 'kode_produk_set', 'nama_produk_set', 'harga', 'status_active', 'id_kategori_produk')
    ->orderBy('nama_produk_set', 'asc')
...
$data_produk = $produkList->map(function($item) use ($kategoriList) {
    ...
    return (object)[
        'kode_produk_set' => $item->kode_produk_set,
        'nama_produk_set' => $item->nama_produk_set,
        'harga'           => $item->harga,
