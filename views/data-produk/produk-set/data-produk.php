<?php require_once __DIR__ . '/query/data-produk-set.php'; ?>
<!-- Custom CSS -->
...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3 mt-2">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Data Produk Set</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="dashboard.php"><i class="ti ti-smart-home"></i></a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page">Data Produk Set</li>
            ...
            <div class="me-2 mb-2 w-custom w-md-auto">
                <div class="dropdown w-custom">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                        <li>
                            <a href="data-produk.php?action=export-pdf-produk-set" target='blank' class="dropdown-item rounded-1">
                                <i class="ti ti-file-type-pdf me-1"></i>Export as PDF
                            </a>
                        </li>
                        <li>
                            <a href="data-produk.php?action=export-excel-produk-set" class="dropdown-item rounded-1">
        ...
        <div class="card-body" style="min-height:70vh">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="text-muted medium">
                    <a href="data-produk.php?action=add-produk-set" class="btn btn-primary btn-mobile">
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 150px;">Status NIE</th>
                        ...
                        <?php if (!$data_produk->isEmpty()) : ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center"><?= $row->kode_produk_set; ?></td>
                                    <td class="align-middle"><?= $row->nama_produk_set; ?></td>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="form-switch">
                                            <input class="form-check-input updateStatus" type="checkbox" value="" id="checkNativeSwitch" <?= $checked_active ?> data-id="<?= encryptId($id_produk_set, $key_akses) ?>" data-status="<?= $status_active ?>" data-action="<?= encryptId('update_status_produk', $key_akses) ?>" data-routename="produk-set" switch>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center text-wrap">
                                        <!-- Button detail -->
                                        <a href="data-produk.php?action=detail-produk-set&&id=<?= encryptId($id_produk_set, $key_akses) ?>" class="btn btn-sm btn-secondary mb-1" title="Detail Produk">
                                            <i class="fe fe-eye"></i>
                                        </a>
                                        <!-- Button isi produk set -->
                                        <a href="data-produk.php?action=isi-produk-set&&id=<?= encryptId($id_produk_set, $key_akses) ?>" class="btn btn-sm btn-info mb-1" title="Isi Produk">
                                            <i class="fe fe-file-text"></i>
                                        </a>
                                        <!-- Button edit -->
                                        <a href="data-produk.php?action=edit-produk-set&&id=<?= encryptId($id_produk_set, $key_akses) ?>" class="btn btn-sm btn-warning mb-1" title="Edit Produk">
                                        ...
                                        <?php  
                                            if($_SESSION['role'] == "Super Admin"){
                                                ?>
                                                    <button class="btn btn-sm btn-danger btnHapusProduk mb-1" data-bs-toggle="modal" data-bs-target="#hapusData" data-id="<?= encryptId($id_produk_set, $key_akses) ?>" title="Hapus Produk">
