<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $satuan_produk              = $data_produk->satuan_produk;
        $select_pcs                 = $satuan_produk  === 'pcs' ? 'selected' : '';
        $select_set                 = $satuan_produk  === 'set' ? 'selected' : '';
    ...
    <div class="card border-0">
        ...
        <div class="card-body" style="min-height:70vh">
            <form class="row g-3 mt-0" method="POST" id="saveForm" enctype="multipart/form-data">
                <input type="hidden" class="form-control" name="id_produk" value="<?= $id_produk ?>">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" maxlength="50" name="kode_produk" value="<?= $kode_produk ?? '' ?>" required>
                </div>
                <div class="col-md-2">
                    <label class="form-label">Kode Katalog</label>
                    <input type="text" class="form-control" maxlength="20" name="kode_katalog" value="<?= $kode_katalog ?? '' ?>" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Nama Produk</label>
                    <input type="text" class="form-control" maxlength="100" name="nama_produk" id="namaProduk" value="<?= $nama_produk ?? '' ?>" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="satuan_produk" class="form-select" required>
                        <option value="">Pilih...</option>
                        <option value="pcs" <?= $select_pcs ?>>Pcs</option>
                        <option value="set" <?= $select_set ?>>Set</option>
                    </select>
                </div>
                <div class="col-4">
                ...
                <div class="col-12">
                    <div class="text-end mt-4" id="formButtons"> 
                        <button type="button" class="btn btn-success me-2" onclick="window.location.href='data-produk.php?action=produk'">
