...
<div class="content">
    ...
    <div class="card border-0">
        <?php
            ...
            try {
                if ($tokenJwt) {
                    $response = $client->get($domain_inventory_kma . 'api/data-produk-ecat.php', [
                        'headers' => [
                        ...
                        <?php if (!empty($data_produk)) : ?>
                            ...
                            <?php foreach ($data_produk as $row) : ?>
                                <?php
                                    ...
                                    $gambar         = $row['gambar'];
                                    $gambarPathReg  = $domain_inventory_kma . 'gambar/upload-produk-ecat/' . $gambar;
            ...
            <div class="mt-1">
                <?php if ($pagination['pages'] > 1): ?>
                    <?php
                        ...
                        $base_url = '?action=produk-karsa-ecat';
                        if (!empty($search)) {
...
<script>
    ...
    if(searchValue !== ''){
        ...
        clearBtn.addEventListener('click', function () {
            window.location.href = 'stock-produk.php?action=produk-karsa-ecat';
        });
    } else {
        clearBtn.style.display = 'none';
    }
