...
<div class="content">
        ...
        <div class="my-auto mb-2">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Stock Produk Set</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card border-0">
        <?php
            ...
            try {
                if ($tokenJwt) {
                    $response = $client->get($domain_inventory_kma . 'api/data-produk-set.php', [
                        'headers' => [
        ...
        <div class="card-body" style="min-height:70vh">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="text-muted medium d-flex gap-2 flex-wrap">
                    <a href="stock-produk.php?action=produk-karsa-reg" class="btn btn-outline-secondary btn-mobile">
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="min-width: 120px;">Stok</th>
                        ...
                        <?php if (!empty($data_produk)) : ?>
                            ...
                            <?php foreach ($data_produk as $row) : ?>
                                <?php
                                    ...
                                    $gambar         = $row['gambar'];
                                    $gambarPathReg  = $domain_inventory_kma . 'gambar/upload-produk-set-marwa/' . $gambar;
            ...
            <div class="mt-1">
                <?php if ($pagination['pages'] > 1): ?>
                    <?php
                        ...
                        $base_url = '?action=produk-karsa-reg-set';
                        if (!empty($search)) {
...
<script>
    ...
    if(searchValue !== ''){
        ...
        clearBtn.addEventListener('click', function () {
            window.location.href = 'stock-produk.php?action=produk-karsa-reg-set';
        });
    } else {
        clearBtn.style.display = 'none';
    }
