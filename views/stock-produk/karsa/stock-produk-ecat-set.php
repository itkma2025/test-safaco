...
<div class="content">
    ...
    <div class="card border-0">
        <?php
            ...
            try {
                if ($tokenJwt) {
                    $response = $client->get($domain_inventory_kma . 'api/data-produk-ecat-set.php', [
                        'headers' => [
        ...
        <div class="card-body" style="min-height:70vh">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="text-muted medium d-flex gap-2 flex-wrap">
                    ...
                    <a href="stock-produk.php?action=produk-karsa-ecat-set" class="btn btn-outline-secondary btn-mobile">
                        ...
                        <?php if (!empty($data_produk)) : ?>
                            ...
                            <?php foreach ($data_produk as $row) : ?>
                                <?php
                                    ...
                                    $gambar         = $row['gambar'];
                                    $gambarPathReg  = $domain_inventory_kma . 'gambar/upload-produk-set-ecat/' . $gambar;
            ...
            <div class="mt-1">
                <?php if ($pagination['pages'] > 1): ?>
                    <?php
                        ...
                        $base_url = '?action=produk-karsa-ecat-set';
                        if (!empty($search)) {
...
<script>
    ...
    if(searchValue !== ''){
        ...
        clearBtn.addEventListener('click', function () {
            window.location.href = 'stock-produk.php?action=produk-karsa-ecat-set';
        });
    } else {
        clearBtn.style.display = 'none';
    }
