...
<?php
    ...
    try {
        if ($tokenJwt) {
            $response = $client->get($domain_instansi . 'api/data-instansi.php', [
                'headers' => [
...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3 mt-2">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Data Instansi</h2>
            <nav>
            ...
            <div class="me-2 mb-2 w-custom w-md-auto">
                <div class="dropdown w-custom">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                        <li>
                            <a href="data-instansi.php?action=export-pdf&search=<?= urlencode($search) ?>" target='blank' class="dropdown-item rounded-1">
                                <i class="ti ti-file-type-pdf me-1"></i>Export as PDF
                            </a>
                        </li>
                        <li>
                            <a href="data-instansi.php?action=export-excel&search=<?= urlencode($search) ?>" class="dropdown-item rounded-1">
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="min-width: 120px;">No. Telp</th>
                            <th class="text-center" style="min-width: 180px;">Email</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (!empty($data_instansi)) : ?>
                            ...
                            <?php foreach ($data_instansi as $row) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-wrap"><?= htmlspecialchars($row['alamat']) ?></td>
                                    <td class="align-middle text-wrap text-end"><?= htmlspecialchars($row['no_telp']) ?></td>
                                    <td class="align-middle text-nowrap text-center"><?= htmlspecialchars($row['email_instansi']) ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <tr>
